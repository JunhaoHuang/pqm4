...
#define DKE1_XOF_BLOCKBYTES 96 // DKE1_XOF_BLOCKBYTES need to be the multiple of 3. Otherwise, some tails are not considered in matacc assembly implementation.
